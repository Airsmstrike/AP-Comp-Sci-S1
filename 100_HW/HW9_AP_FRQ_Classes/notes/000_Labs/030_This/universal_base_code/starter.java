...
class starter {
	...
	public static void main(String args[]) {
        ...
        if (dwarf2.isSameName(firstDwarfName)) duplicateCount++;
        if (dwarf3.isSameName(firstDwarfName)) duplicateCount++;
        if (dwarf4.isSameName(firstDwarfName)) duplicateCount++;
        if (dwarf5.isSameName(firstDwarfName)) duplicateCount++;
        if (dwarf6.isSameName(firstDwarfName)) duplicateCount++;
        if (dwarf7.isSameName(firstDwarfName)) duplicateCount++;
